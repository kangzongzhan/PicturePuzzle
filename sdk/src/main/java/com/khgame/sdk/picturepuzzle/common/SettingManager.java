...
/**
 * Version 1.1 Created by N on 14/9/2014. Last Edited 13/5/2015 * Support for
 * syncing data to wearables
 */
...
public class SettingManager {
    ...
    /**
     * Takes saved game data that is in the JSON format and updates
     * SharedPreferences
     *
     * @param json
     *            JSONObject containing SharedPreferences in key->value pairs
     */
        ...
        try {
            ...
            while (keys.hasNext()) {
                ...
                if (v.getClass().toString().contains("Boolean")) {
                    ...
                    setInt(key, (Integer) v);
                } else if (v.getClass().toString().contains("Long")) {
                    setLong(key, (Long) v);
                }
                // Log.d(TAG, "Read " +
                // dataObject.get(key).getClass().toString() + " " + key + " = "
    ...
    /**
     * Takes saved game data that is in a byte array and updates
     * SharedPreferences
     *
     * @param gameData
     *            Saved game data snapshot from Google Drive
     */
    ...
    public JSONObject writeSnapshot() {
        ...
        for (String s : keys) {
            try {
                ...
                // Log.d(TAG, "Write "+value.getClass().toString()+" "+s+" =
                // "+value);
    ...
    /**
     * Writes all SharedPreferenes data to a byte array This is useful for
