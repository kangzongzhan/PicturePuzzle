...
import com.khgame.sdk.picturepuzzle.service.operation.GetSerialPicturesFromServiceBySerialUuidOperation;
...
public class InstallSerialOperation extends Operation<Void, Void> {
    ...
    protected void doWork() {
        ...
        new GetSerialPicturesFromServiceBySerialUuidOperation(serial.uuid).callback(new Operation.Callback<List<SerialPictureDto>, Void>() {
            @Override
